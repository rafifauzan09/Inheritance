...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Fauzan", 16);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Budi Agnoerdi", 36, "190345", "Pancasila");
            teacher.GetNameAndAge();

            Student student = new Student("Rafif Fauzan Almahdy", 16, "19.11.2742", "rafif.almahdy@students.amikom.ac.id");
